...
function Texto({ title, subtitle, imageUrl, content, views, badgeType, publishedAt }: TextoProps) {
  ...
  return (
    <div className="flex flex-col ">
      ...
      {/* Título */}
      <div className="w-full text-left text-gray-900 font-extrabold text-[40px] mb-3">
        {title}
      </div>
